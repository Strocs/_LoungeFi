...
export function ModifyTask({ task, id }) {
	...
	return (
		<form onSubmit={onTaskEdit} className='flex gap-2 items-center'>
			<input disabled={isDisabled} type='text' className='w-full text-lg bg-c-box focus:outline-1 focus:outline-c-text focus:outline-dashed' ref={taskRef} defaultValue={task} />
